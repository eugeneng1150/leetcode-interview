...
The extension uses a user-provided OpenAI API key to generate hints and review responses. The extension does not provide shared API credits or a project-owned hosted backend in the primary user flow.
